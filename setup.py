...
setup(	name='py2d',
	...
	ext_modules = [
		...
		Extension("py2d.Math", ["py2d/Math.py"]),
		Extension("py2d.Navigation", ["py2d/Navigation.py"]),
		Extension("py2d.SVG", ["py2d/SVG.py"]),
		Extension("py2d.vecmath.Operations", ["py2d/vecmath/Operations.py"]),
		Extension("py2d.vecmath.Polygon", ["py2d/vecmath/Polygon.py"]),
		Extension("py2d.vecmath.Transform", ["py2d/vecmath/Transform.py"]),
		Extension("py2d.vecmath.Vector", ["py2d/vecmath/Vector.py"]),
	]
)
