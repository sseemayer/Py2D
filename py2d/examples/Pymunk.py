...
from py2d.examples.Logo import PY2D_LOGO
import py2d.examples.Main

import pymunk as pm
import pymunk.constraint as pmc

class LogoPhysics(py2d.examples.Main.Example):
	"""Logo (physics) sample
	...
	def __init__(self, runner):
		...
		transform = Transform.move(py2d.examples.Main.SCREEN_WIDTH / 2, 10) * Transform.scale(5,5) * Transform.move(-self.w / 2 - p.left, -self.h / 2 - p.top)
		...
		tray = pm.Body()
		tray_left = pm.Segment(pm.Body(), (0,0), (0,py2d.examples.Main.SCREEN_HEIGHT), 5)
		tray_right = pm.Segment(pm.Body(), (py2d.examples.Main.SCREEN_WIDTH,0), (py2d.examples.Main.SCREEN_WIDTH,py2d.examples.Main.SCREEN_HEIGHT), 5)
		tray_bottom = pm.Poly(pm.Body(), [(0,py2d.examples.Main.SCREEN_HEIGHT/2), (py2d.examples.Main.SCREEN_WIDTH,py2d.examples.Main.SCREEN_HEIGHT), (0, py2d.examples.Main.SCREEN_HEIGHT)])
	...
	def render(self):
		pygame.draw.polygon(self.runner.screen, 0x000000, [(0,py2d.examples.Main.SCREEN_HEIGHT/2), (py2d.examples.Main.SCREEN_WIDTH, py2d.examples.Main.SCREEN_HEIGHT), (0, py2d.examples.Main.SCREEN_HEIGHT)])
